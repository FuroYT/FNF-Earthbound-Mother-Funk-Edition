...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Cinematics', "Value 1: Start of Cinematic\nMark this Value with 1 to begin the event\n\nValue 2: End of Cinematic\nMark this Value with 2 to end the event"],
		['Goodbye Hud', "hud is gone\n\nvalue 1: opacity\nvalue 2: speed"],
		['Camera Flash', 'Value 1: Length of fade out in seconds.'],
		['Set CamZoom', "Sets how much it zooms.\n\nValue 1: CamZoom\n\nValue 2: if blank, it will smoothly zoom regularly,\notherwise it will do an instant zoom"]
	];
