...
class FlxG
{
	...
	public static var scaleMode(default, set):RatioChangeScale = new RatioChangeScale();
	...
	static function set_scaleMode(ScaleMode:RatioChangeScale):RatioChangeScale
	{
		scaleMode = ScaleMode;
		game.onResize(null);
		return ScaleMode;
